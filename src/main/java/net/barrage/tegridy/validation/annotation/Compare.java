...
/**
 * The {@code Compare} annotation is used to enforce a comparison constraint between two fields of a
 * Java Bean class. This annotation allows you to specify two fields and a comparator class which
 * will be used to perform the comparison logic.
 *
 * <p>This constraint is repeatable, meaning multiple {@code Compare} annotations can be applied to
 * the same class.
 *
 * <p>Example usage:
 *
...
public @interface Compare {
  ...
  /**
   * The name of the method that will be used to perform the comparison between fields. This method
   * should be defined in the class using this annotation.
   *
   * <p>The method specified by this attribute is invoked to compare the values of the base field
   * and the comparison field. The method should return a boolean value indicating the result of the
   * comparison.
   *
