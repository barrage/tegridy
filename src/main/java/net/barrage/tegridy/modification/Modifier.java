 ...
 *
 * <p>Any <strong>public</strong> class with an empty constructor that implements this interface is
 * valid in {@link ModifyCustom}.
 *
 * <p>Note, the class must be public and the Modifier generic must match the type of the field,
