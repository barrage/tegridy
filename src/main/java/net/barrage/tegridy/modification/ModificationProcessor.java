...
public class ModificationProcessor extends AbstractProcessor {
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
      ...
      if (!typesMatch) {
        processingEnv
            ...
            .printMessage(
                ...
                "Field '"
                    + field.getSimpleName()
                    + "' must be of type String. Required because of String modifier.",
                element);
      }
    }
            ...
            processingEnv
                ...
                .printMessage(
                    ...
                    "Field '"
                        ...
                        + "' of type ("
                        + field.asType()
                        + ") does not match the modifier type ("
                        + type
                        + ").",
                    element);
          }
    ...
    for (var element : nestedElements) {
      ...
      var hasModify =
          methods.stream().map(el -> el.getSimpleName().toString()).toList().contains("modify");
