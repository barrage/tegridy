...
public class EnumStringProcessorTests {
  ...
  public void testPass() {
    JavaFileObject source = JavaFileObjects.forResource("processor/enumstring/CorrectClass.java");

    Compilation compilation = javac().withProcessors(new EnumStringProcessor()).compile(source);
  ...
  public void testErrorNoBaseField() {
    JavaFileObject source = JavaFileObjects.forResource("processor/enumstring/WrongTypeClass.java");
