...
public class CompareProcessorTests {
  ...
  public void testPass() {
    JavaFileObject source = JavaFileObjects.forResource("processor/compare/CorrectClass.java");

    Compilation compilation = javac().withProcessors(new CompareProcessor()).compile(source);
  ...
  public void testErrorNoBaseField() {
    JavaFileObject source = JavaFileObjects.forResource("processor/compare/MissingBaseField.java");
  ...
  public void testErrorIllegalReturnType() {
    JavaFileObject source = JavaFileObjects.forResource("processor/compare/IllegalReturnType.java");
  ...
  public void testErrorIllegalParametersType() {
    JavaFileObject source = JavaFileObjects.forResource("processor/compare/IllegalParameters.java");
