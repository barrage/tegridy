...
public class RequiresNotNullProcessorTests {
  ...
  public void testPass() {
    JavaFileObject source =
        JavaFileObjects.forResource("processor/requiresnotnull/CorrectClass.java");

    Compilation compilation =
        javac().withProcessors(new RequiresNotNullProcessor()).compile(source);
  ...
  public void testErrorMissingMainField() {
    JavaFileObject source =
        JavaFileObjects.forResource("processor/requiresnotnull/MissingMainFieldClass.java");
  ...
  public void testErrorMissingRequiredFields() {
    JavaFileObject source =
        JavaFileObjects.forResource("processor/requiresnotnull/MissingRequiredFieldsClass.java");
