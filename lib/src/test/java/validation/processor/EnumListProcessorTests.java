...
public class EnumListProcessorTests {
  ...
  public void testPass() {
    JavaFileObject source =
        JavaFileObjects.forResource("processor/enumlist/CorrectClass.java");

    Compilation compilation = javac()
        .withProcessors(new EnumListProcessor())
        .compile(source);
  ...
  public void testErrorNoBaseField() {
    JavaFileObject source =
        JavaFileObjects.forResource("processor/enumlist/WrongTypeClass.java");
