...
public class ModifyProcessorTests {
  ...
  public void mismatchedStringTypesFailCompilation() {
    ...
    assertThat(compilation.errors().toString(),
        containsString(
            "Field 'foo' must be of type String. Required because of String modifier."));
    assertThat(compilation.errors().toString(),
        containsString(
            "Field 'bar' must be of type String. Required because of String modifier."));
    assertThat(compilation.errors().toString(),
        containsString(
            "Field 'baz' must be of type String. Required because of String modifier."));
    assertThat(compilation.errors().toString(),
        containsString(
            "Field 'qux' must be of type String. Required because of String modifier."));
  }
  ...
  Compilation compile(String path) {
    ...
    return javac()
        .withProcessors(new ModificationProcessor())
        .compile(source);
  }
}
