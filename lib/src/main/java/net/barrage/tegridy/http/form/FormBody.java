...
/**
 * Implement on classes that need to be transformed into multipart payloads.
 * Only non null values of the classes will get mapped with the exception
 * of primitives, which take on their default value.
 */
